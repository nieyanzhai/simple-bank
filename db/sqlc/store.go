...
type Store interface {
	Querier
	ExecTransferTx(ctx context.Context, arg TransferTxParams) (TransferTxResult, error)
}
...
func (s *SqlStore) ExecTransferTx(ctx context.Context, arg TransferTxParams) (TransferTxResult, error) {
